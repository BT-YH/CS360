...
//     /*$sql = "SELECT MESSAGES.msg_date, MESSAGES.msg_subject, MESSAGES.sender_username, USER.fname as senderfname , USER.lname AS senderlname 
//             FROM MESSAGES JOIN USER ON rec_username = USER.username
//             ";*/
//     // $sql = "SELECT *
//     //         FROM MESSAGES JOIN USER AS U1 ON MESSAGES.rec_username = U1.username
//     //         JOIN USER AS U2 ON U2.username = MESSAGES.sender_username
...
function genUpdateForm() {
    ...
    echo "Password: <input type='text' name='password' placeholder='New Password'><br>";  // Password field changed to text type
